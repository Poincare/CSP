function ParametersANDBiograph()
    ...
    m = explore_vars_f(-ones(V, V, S, T), EE, SS, V, S, T, E, TT, ST, edge);
    fprintf('\n----------------------------------------------------------------\n')
    fprintf('\n================================================================\n')
    fprintf('\n----------------------------------------------------------------\n')
    %reduces x dimensionality (useless at the moment since we are manually
    %setting x values from beta values)
